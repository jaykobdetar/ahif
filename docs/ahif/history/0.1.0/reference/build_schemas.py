...
D['manifest']=obj({'format':{'const':'AHIF'},'format_version':{'const':'0.1.0'},'dataset_id':text(256,1),
...
D['record']=obj({'format_version':{'const':'0.1.0'},'observation_id':ref('hash_id'),'record_key':ref('key'),
...
D['account']=obj({'format_version':{'const':'0.1.0'},'observation_id':ref('hash_id'),'account_key':ref('key'),
